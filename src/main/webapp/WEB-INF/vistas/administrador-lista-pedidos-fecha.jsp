...
<link href="../../../../css/bootstrap-theme.min.css" rel="stylesheet">
                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                        	<li><a class="navactive color_animation" href="../../../../../administrador">Home</a></li>
                            <li><a class="navactive color_animation" href="../../../../../administrador/lista-pedidos-entregados">Historial Completo</a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                </div>
            </div><!-- /.container-fluid -->
	...
	<!-- ============ Pan Section  ============= -->
      <div class="titulo jumbotron" id="aListComp">
      	<div class="container">
      		<h2>Pedidos Entregados - Fecha ${day }/${month }/${year }</h2>
      	</div>
      </div>
      <div class="container">
       <div class="row">
       	<div class="col-md-12">
       		<table class="table table-hover">
				...
				<tbody>
					<c:forEach items="${listaPedidosFecha}" var="pedido">
						<tr id="idPedido_${pedido.idPedido}" >
							...
							<td><c:out value="${pedido.precioPedido}"/></td>
						</tr>
					</c:forEach>
				</tbody> 
			</table>
